// Typed client for the Instagram-for-couples Circles API. Every function wraps a
// route on the NestJS CirclesController, uses the shared axios `api` instance
// (auto-attaches the bearer token), and returns the unwrapped `data` payload
// from the { success, data } envelope. Endpoints/shapes match
// apps/api/src/modules/circles/circles.{controller,service}.ts EXACTLY.
